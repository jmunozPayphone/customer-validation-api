...
public class Result : IResult
{
    protected internal Result(bool isSuccess, Error error)
    {
        ...
        {
            throw new InvalidOperationException("Cannot have a successful result with a non-empty error.");
        }
...
public class Result<TValue> : Result
{
    ...
    public static Result<TValue> ToResult(TValue value) => Create(value);
